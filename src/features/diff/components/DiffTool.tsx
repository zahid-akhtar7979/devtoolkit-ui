...
import { diffService } from '../api/diffService';
import { useApi } from '../../../shared/hooks/useApi';
import { ResultCard } from '../../../shared/components/ResultCard';
import { LoadingButton } from '../../../shared/components/LoadingButton';
import { validation } from '../../../shared/utils/validation';
import { DiffRequest } from '../../../shared/types';
...
const DiffTool: React.FC = () => {
  ...
  const diffApi = useApi(diffService.compare);
...
function divide(x, y) {
  ...
  const formatJsonWithHighlights = (jsonText: string, side: 'left' | 'right') => {
    try {
      ...
      if (!diffApi.data) return formatted;

      let highlighted = formatted;
      
            // Note: structuralChanges is not available in the new API
      // This highlighting functionality would need to be implemented differently
      return formatted;
